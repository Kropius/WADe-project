...
const ResultsArea = forwardRef((props, ref) => {
        const mockedResponse = "{\"path\":\"this/is/your/path\",\"responseBody\":{\n" +
            "\t\"random\": 10,\n" +
            "\t\"random float\": 39.193,\n" +
            "\t\"bool\": false,\n" +
            "\t\"date\": \"1999-04-23\",\n" +
        ...
        return (
            <div className={ResultsAreaStyle.container}>
                {messages.map((message) => (!isEmpty(message.message) && [
                        message.isRequest ? <RequestMessage message={message.message}/> :
